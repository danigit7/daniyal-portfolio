...
const Header = (props: Props) => {
  return (
    <header className="sticky top-0 flex items-start justify-between max-w-7xl mx-auto z-40 xl:items-center p-5  ">
      ...
      >
        {/* Social icons */}
        {props.data.show_github && <SocialIcon
        ...
        {props.data.show_linkedin && <SocialIcon
        ...
        {props.data.show_whatsapp && <SocialIcon
      ...
      >
        ...
        {props.data.show_resume && <a href={props.data.resume} target="_blank" rel="noreferrer">
